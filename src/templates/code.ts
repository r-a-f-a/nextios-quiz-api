                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="https://quiznextios.com.br/validate/?code={code}" target="_blank"
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0; text-align: center;">Se isso não funcionar, copie e cole o seguinte link no seu
                navegador:</p>
              <p style="margin: 0; text-align: center;"><a href="https://quiznextios.com.br/validate/?code={code}"
                  target="_blank">https://quiznextios.com.br/validate/?code={code}</a></p>
            </td>
          </tr>
          <!-- end copy -->
